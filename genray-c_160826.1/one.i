...
c     bx,by,bz,br,bphi  - components of the magnetic field
...
c     i_      - number of the file for wr
...
c          and finds X mode.
c ox_step_dir   is the type of stepping !YuP[11-2016] 
c               when looking for X-mode across evanescent layer.
c               'gradne' - step along grad(n) direction, or
c               'vgroup' - along Vgroup velocity direction
c                        taken just before O-X jump is initiated.
c-------------------------------------------------------------------            
