...
c     nraymax must be greater or equal than nray (obtained in code).
     ...
     1            rstj,phistj,
     1            betaj,alphaj,
     1            x_st_ox, y_st_ox, z_st_ox, r_st_ox, phi_st_ox,
     1            alpha_st_ox,beta_st_ox, 
     1            disk_power_equal,
     1            power_per_ray,
     ...
     1            icone_loc
      ...
      common/cone/
     1	          powj(nraymax),
     1            xstj(nraymax),ystj(nraymax),zstj(nraymax),
     1            rstj(nraymax),phistj(nraymax),
     1            betaj(nraymax),alphaj(nraymax),
     1            x_st_ox, y_st_ox, z_st_ox, r_st_ox, phi_st_ox,
     1            alpha_st_ox,beta_st_ox,
