...
c      the variables for the grill parameters
c      No namelist data.
c------------------------------------
...
c------------------------------------
        ...
        real*8
     1  arxu0,aryu0,arzu0, arru0,arphiu0,
     1  arnpar,arnper_tang,
     1	arntheta,arnphi,powinilh,
     1  fpwth,wtheta,wtheta_edge,
     1  anzin,anzin_edge,pwcpl,
     1  wdnpar0,
     1  anztorin,anzpolin,
     1  anztorin_edge,anzpolin_edge,
     1  pwcpl_tp,
     1  pwcpl_t_ar,pwcpl_p_ar  
     
   
        common /grill/
     1  arxu0(nraymaxl),aryu0(nraymaxl),arzu0(nraymaxl),
     1  arru0(nraymaxl),arphiu0(nraymaxl),
     1	arntheta(nraymaxl),arnphi(nraymaxl),powinilh(nraymaxl),
     1  arnpar(nraymaxl),arnper_tang(nraymaxl),
     1  fpwth(nthinmax),wtheta(nthinmax),wtheta_edge(nthinmax+1),
     1  anzin(nnkprmax),anzin_edge(nnkprmax+1),pwcpl(nnkprmax),
     1  wdnpar0(nraymaxl),
     1  anztorin(nnktormax),anzpolin(nnkpolmax),
     1  anztorin_edge(nnktormax+1),anzpolin_edge(nnkpolmax+1),
     1  pwcpl_tp(nnktormax,nnkpolmax),
     1  pwcpl_t_ar(nnktormax),pwcpl_p_ar(nnkpolmax)  
