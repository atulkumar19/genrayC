...
c------------------------------------------------------------------
     ...
     1nbulk,bmod,cnprim_e,cnprim_i,cnprim_s)
      ...
      dimension tempiar(nbulka)
      double precision mu,mu2
      parameter (nb=200) ! the max order of the modifed Bessel function
      dimension br(nb),bi(nb)
...
c      real rpr,rpim
      ...
      stop ' absorpfw_pinsker()  Not setup'
...
c      real rpr,rpim
      ...
      stop ' absorpfw_pinsker_1()  Not setup'
...
c-------------------------------------------------------------------   
      cnperp=dcmplx(cnper,0.d0)
      call efield1(cnpar,cnperp,ex,ey,ez,eplus,eminus,epar)
      ce(1)=cex
      ce(2)=cey   
      ce(3)=cez
c-------------------------------------------------------------------
...
c------------------------------------------------------------------
     ...
     1nbulk,bmod,cnprim_e,cnprim_i,cnprim_s)
      ...
      stop ' absorpfw_pinsker_2()  Not setup'
